...
export const TEMPLATES: TemplateMeta[] = [
  ...
  { id: "bistro", name: "Bistro", description: "Warm and classic", swatch: ["#2a2218", "#e9d8b4"], Component: BistroTemplate },
  { id: "manhattan", name: "Manhattan", description: "Cocktail-bar bold", swatch: ["#0f1115", "#d4a24a"], Component: ManhattanTemplate },
  { id: "cellar", name: "Cellar", description: "Sommelier-focused", swatch: ["#241016", "#a0743a"], Component: CellarTemplate },
  { id: "provence", name: "Provence", description: "Soft, floral, modern", swatch: ["#5b6b4f", "#f3e9d8"], Component: ProvenceTemplate },
  { id: "tokyo", name: "Tokyo", description: "Minimal, monospace", swatch: ["#111111", "#e7e3dc"], Component: TokyoTemplate },
