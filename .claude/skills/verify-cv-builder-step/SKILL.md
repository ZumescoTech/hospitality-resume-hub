...
4. At >=1024px, confirm the editor and preview render as two independent side-by-side panes rather than tabs; below 1024px, confirm the tabbed mode-switcher layout from Steps 1-7 is unchanged.
